...
import { ArrowLeft, Save, Trash2, Play, Copy, Plus } from 'lucide-react'
...
export default function EditWorkflow() {
  ...
  const { updateWorkflow, deleteWorkflow, testWorkflow, duplicateWorkflow, isWorkflowActionLoading } = useWorkflows()
  ...
  // Reset form when workflow data loads
  React.useEffect(() => {
    if (workflow) {
      reset({
        name: workflow.name,
  ...
  const handleTest = () => {
    if (!id) return
    testWorkflow(id, { test_type: 'mock_data' })
  }
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle="Update your workflow configuration"
        breadcrumbs={[
              ...
              <CardContent>
                {actions.length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-secondary-500 mb-4">No actions configured</p>
                    <Button
                      type="button"
                      variant="outline"
                      onClick={addNewAction}
                  ...
                  <div className="space-y-4">
                    {actions.map((action, index) => (
                      <Card key={action.id || index} variant="outlined">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-secondary-200">
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  ...
                  disabled={isWorkflowActionLoading || !isDirty}
